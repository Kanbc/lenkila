    ...
    if (this.state.isEdit === true) {
      ...
      button1 = (
        <ButtonModal
          ...
          width={Constant.Buttons.default}
          modalName={`#history-${this.props.userData.id}`}
        >
          ประวัติ
          <HistoryModal
            title="ประวัติ"
            type={`history-${this.props.userData.id}`}
      ...
      >
        <Body>
          <div className="row">
            ...
            <div className="col-sm-2">
              <p className={this.state.isEdit ? "d-none" : ""}>
                {this.state.nick_name}
              </p>
              <input
                type="text"
                className={
                  this.state.isEdit ? "form-control" : "form-control d-none"
                }
                id="firstname"
          ...
          <div className="row">
            ...
            <div className="col-sm-2">
              ...
              <select
                className={
                  this.state.isEdit ? "custom-select" : "custom-select d-none"
                }
          ...
          <div className="row">
            ...
            <div className="col-sm-2">
              <p className={this.state.isEdit ? "d-none" : ""}>
                {this.state.customer_duty}
              </p>
              <select
                className={
                  this.state.isEdit ? "custom-select" : "custom-select d-none"
                }
                defaultValue={this.state.customer_duty}
                onChange={e => this.setState({ customer_duty: e.target.value })}
              >
            ...
            <div className="col-sm-2">
              <p className={this.state.isEdit ? "d-none" : ""}>
                {this.state.customer_relationship}
              </p>
              <select
                className={
                  this.state.isEdit ? "custom-select" : "custom-select d-none"
                }
                defaultValue={this.state.customer_relationship}
                onChange={e =>
                  this.setState({ customer_relationship: e.target.value })
                }
              >
            ...
            <div className="col-sm-2">
              <p className={this.state.isEdit ? "d-none" : ""}>
                {this.state.customer_freecredits}
              </p>
              <input
                type="text"
                className={
                ...
                id="nickname"
                defaultValue={this.state.customer_freecredits}
                onChange={e =>
                  this.setState({ customer_freecredits: e.target.value })
                }
              />
            </div>
          </div>
          <div className="row">
            ...
            <div className="col-sm-2">
              <p>
                {this.props.userData.customer_type_history.length !== 0
                  ? this.props.customerTypeId.name
                  : this.props.userData.customer_type_default}
              </p>
            </div>
            <div className="col-sm-2">
              <ButtonModal
                color={Constant.Orange}
                width={Constant.Buttons.default}
                modalName={`#member-${this.props.userData.id}`}
              >
                Member
                <MemberModal
                  title="Member"
                  type={`member-${this.props.userData.id}`}
          ...
          <div className="row">
            ...
            <div className="col-sm-2">
              <label
                className={
                  this.state.isEdit
                    ? "form-check-label red-label"
                    : "form-check-label red-label d-none"
                }
              ...
              >
                <input
                  ...
                  id="inlineCheckbox5"
                  value="0"
                  defaultValue={this.state.is_blacklist}
                  onChange={() =>
                    this.setState({
                      is_blacklist: this.state.is_blacklist === "0" ? "1" : "0"
                    })
                  }
                  checked={this.state.is_blacklist === "1"}
                />
                Blacklist
              </label>
            </div>
