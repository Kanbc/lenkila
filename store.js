...
export const actionTypes = {
  ...
  ADD_BOOST: "ADD_BOOST",
  EDIT_BOOST: "EDIT_BOOST",
  DELETE_BOOST: "DELETE_BOOST"
};
...
export const editBoost = data => {
  return {
    type: actionTypes.EDIT_BOOST,
    data
  };
};

export const deleteBoost = (id, date) => {
  return {
    type: actionTypes.DELETE_BOOST,
    id,
    date
  };
};
